...
/// <summary>
/// Curated Dutch stop-word list (articles, pronouns, prepositions, conjunctions and common
/// auxiliary verb forms), applied only when <c>ReperioOptions&lt;TMeta&gt;.RemoveStopWords</c> is enabled.
/// </summary>
public sealed class DutchStopWords : IStopWordFilter
{
    private static readonly HashSet<string> Words = new(StringComparer.Ordinal)
    {
        ...
        "eens", "hier", "wie", "werd", "altijd", "doch", "wordt", "wezen", "kunnen", "ons",
        "zelf", "tegen", "na", "reeds", "wil", "kon", "niets", "uw", "iemand", "geweest",
        "andere",
    };

    /// <summary>Returns <see langword="true"/> if <paramref name="token"/> is a Dutch stop word.</summary>
